...
@section('content')
<div class="container">
    <a href='{{route("add-task-form")}}' class='text-decoration-none'>
        ...
        <div class='d-flex flex-column bg-primary text-white py-3 my-3 rounded-15'>
            ...
            <div id='task-actions' class='d-flex flex-row justify-content-between'>
                ...
                <div class='d-flex flex-row mx-3'>
                    <a href='{{route("edit-task-form", ["taskId" => $task->id])}}' class='align-self-center'>
                    ...
                    <a href='{{route("delete-task", ["taskId" => $task->id])}}' class='align-self-center'>
