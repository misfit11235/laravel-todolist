            ...
            <div id='task-actions' class='d-flex flex-row justify-content-between'>
                ...
                <div class='d-flex flex-row mx-3'>
                    <a href='#' class='align-self-center'>
                        <svg class='mx-2 action-hover' version="1.1" width='35' height='35' id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 55.25 55.25" style="enable-background:new 0 0 55.25 55.25;" xml:space="preserve">
